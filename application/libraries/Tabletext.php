...
class Tabletext{
	...
	/*** 
		@Custom defined by Maha Andar Pasaribu 
		@16 January 2018
	...
	***/
	public function __construct($params){
		...
		*/
		...
		$this->line = empty($params['line']) ? "-" : $params['line'];
		$this->border = empty($params['border']) ? "|" : $params['border'];
		$this->bodyspace = empty($params['bodyspace']) ? " " : $params['bodyspace'];
		$this->header="";
		$this->footer="";
		$this->body="";
		$this->current_column=0;
		$this->initColumnBase($params['width'], $params['column']);
		$this->initLine();
		$this->initSpace();
