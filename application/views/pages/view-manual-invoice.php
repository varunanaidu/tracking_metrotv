			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						<div class="card-body">
							<table id="invMTbl" class="table table-bordered table-hover table-striped" style="font-size: 10pt !important; table-layout: fixed;">
								<thead>
									<tr>
										<th width="5">id</th>
		...
		<div id="default-modal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" tabindex="-1">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form method="POST" id="invM-form" accept-charset="UTF-8">
							...
							<div id="coreForm" style="display: none;">
								<div class="row clearfix">							
									<div class="form-group col-md-6">
										...
										<select class="form-control" name="PONo" id="PONo" style="width: 360px;"></select>
										<button type="button" class="btn btn-sm btn-warning btn-edit-po-no" title="Change PO No" style="display: none;"><i class="fas fa-pencil-alt"></i> Change PO No.	</button>
									</div>
									<div class="form-group col-md-6">
										...
										<input type="hidden" name="autocomplete" id="autocomplete" value="0">
									</div>
								</div>
								<hr style="border-top:2px solid maroon">
								<div class="row clearfix">
									<div class="form-group col-md-6">
										...
										<input type="text" name="PO_Type" id="PO_Type" class="form-control" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-6">
										<label>Billing Type<span class="text-red">*</span></label>
										<input type="text" name="BillingType" id="BillingType" class="form-control" placeholder="..." readonly="">
									</div>
								</div>
								<hr style="border-top:2px solid maroon">
								<div class="row clearfix">
								...
								<div class="row clearfix">
									<div class="form-group col-md-8">
										...
										<input type="text" class="form-control" id="AdvertiserName" maxlength="100" name="AdvertiserName" value="" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-4">
										<label>Advertiser Telp<span class="text-red">*</span></label>
										<input type="text" class="form-control" id="AdvertiserTelp" maxlength="100" name="AdvertiserTelp" value="" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-12">
										<label>Advertiser Address<span class="text-red">*</span></label>
										<input type="text" class="form-control" id="AdvertiserAddr" maxlength="100" name="AdvertiserAddr" value="" placeholder="..." readonly="">
									</div>
								</div>
								<hr style="border-top:2px solid maroon">
								<div class="row clearfix">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="ProductName" maxlength="100" name="ProductName" value="" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-6">
										<label>AE <span class="text-red">*</span></label>
										<input type="text" class="form-control" id="AE_Name" maxlength="100" name="AE_Name" value="" placeholder="..." readonly="">
									</div>
								</div>
								<hr style="border-top:2px solid maroon">
								<div class="row clearfix">
									<div class="form-group col-md-4">
										...
										<input type="number" class="form-control" step="any" id="AgencyDisc" maxlength="100" name="AgencyDisc" value="" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-4">
										<label>Gross <span class="text-red">*</span></label>
										<input type="number" class="form-control" id="Gross" maxlength="100" name="Gross" value="" placeholder="..." readonly="">
									</div>
									<div class="form-group col-md-4">
										<label>Nett <span class="text-red">*</span></label>
										<input type="number" class="form-control" id="Nett" maxlength="100" name="Nett" value="" placeholder="..." readonly="">
									</div>
								</div>
							</div>
						</div>
