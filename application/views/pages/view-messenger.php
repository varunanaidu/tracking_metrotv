					...
					<div class="card-body table-responsive">
						<div class="row">
							<div class="col-6 form-group">
								<button type="button" class="btn btn-sm btn-info btn-external" title="Send Using External">External Messenger</button>
								<button type="button" class="btn btn-sm btn-info btn-internal" title="Send Using Internal">Internal Messenger</button>
							</div>
						</div>
						<table id="messengerTbl" class="table table-bordered table-hover" style="font-size: 10pt !important;">
							<thead>
								<tr>
									<th width="5">id</th>
